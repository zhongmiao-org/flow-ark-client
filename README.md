...
模板库目前含 BOSS、智联两个本地模板。真实网站适配与业务验收尚未完成，程序会阻止外发；没有上线模板商店。Chrome 的基础 localhost 通用流程已验证；0.1.5 在超时和取消后再次下载的恢复回归中发现 Chrome 原生崩溃，尚未生成该版本安装包。Firefox、Safari、Windows 尚未验收。
